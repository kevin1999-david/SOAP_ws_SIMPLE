 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://webservice.kevapp.com/", wsdlLocation = "http://localhost:8080/WS/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://webservice.kevapp.com/", "CalculatorImplService");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://webservice.kevapp.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.kevapp.com/", "CalculatorImplPort"), Calculator.class, features);
    }
