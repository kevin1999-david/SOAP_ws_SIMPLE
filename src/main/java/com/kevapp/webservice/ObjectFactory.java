 ...
 * generated in the com.kevapp.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _OperationResponse_QNAME = new QName("http://webservice.kevapp.com/", "operationResponse");
    private final static QName _Operation_QNAME = new QName("http://webservice.kevapp.com/", "operation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.kevapp.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.kevapp.com/", name = "operationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.kevapp.com/", name = "operation")
